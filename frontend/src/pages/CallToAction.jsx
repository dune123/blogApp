...
const CallToAction = () => {
  return (
    <div className='flex flex-col sm:flex-row border text-center' style={{border:"1px solid teal",borderTopLeftRadius:"1rem",borderBottomRightRadius:"1rem",display:"flex",justifyContent:"center",alignItems:"center"}}>
