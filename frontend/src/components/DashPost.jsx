...
const DashPost = () => {
    ...
    const handleDeletePost=async()=>{
        setShowModal(false);
        try {
            const res=await axios.delete(`http://localhost:3000/api/post/deletePost/${postIdToDelete}/${currentUser._id}`,{
                headers: {
  ...
  return (
    ...
    style={{marginLeft:'21vw',overflowX:'auto',
    padding: "0.75rem",
    margin:"0 auto"}}
    >
                        ...
                        <Table.Row className='bg-white dark:border-gray-700 dark:bg-gray-800'>
                            ...
                            <Table.Cell>
                                <Link className='text-teal-500 hover:underline cursor-pointer' to={`/update-post/${post._id}`}>
                                    <span style={{color:"#38b2ac"}}>Edit</span>
                                </Link>
                            </Table.Cell>
                        </Table.Row>
                    </Table.Body>
